#!/usr/bin/env node
// Merchant Brain MCP server (stdio). Exposes the grounded knowledge base as tools
// any MCP client (Claude Desktop, Cursor, Claude Code) can mount. Reuses the same
// lib functions as the web app — no logic duplicated.
...
import type { CanonicalFact } from '../lib/brain/types';
